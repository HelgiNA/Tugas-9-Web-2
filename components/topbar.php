...
<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="about.php" class="nav-link">About</a></li>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-inline"><?php echo $_SESSION['login_user']; ?></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        ...
                        <p>
                            ...
                            <small>Teknologi Rekayasa Perangkat Lunak. 2025</small>
                        </p>
                    </li>
                    <!--end::User Image-->
                    <!--begin::Menu Footer-->
                    <li class="user-footer">
                        ...
                        <a href="<?php echo BASE_URL ?>logout.php" class="btn btn-default btn-flat float-end">Sign
                            out</a>
                    </li>
                    <!--end::Menu Footer-->
                </ul>
